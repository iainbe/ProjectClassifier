...
The CoSTAR project has five distinct deliverable streams, each with its own version chain:
...
- "GJ edits" on v02 suggests a collaborator (GJ) provided edits, but the canonical version remains the Jan 30 document.

## 3. Version chain — A. Case for Support
...
## 6. Version chain — E. Consortium Plan
...
1. **Bid support, not a delivered report:** This is bid-support work, not a delivered report. The R2 diagnostic (R2-D07) tests "what can this Manchester case-for-support establish about bid-support work and the funding outcome?"

2. **National competition:** The CoSTAR bid was a national competition — the R2 test checks for national/local conflation. This is a distinct commission type from local authority mapping projects.
...
5. **Key analytical questions for R3:**
   ...
   - What was Fifth Sector's specific role in the consortium?
