...
|---|---|---|---|---|---|
| 2022 report | 22/06 | `2206 Kirklees Creative Economy final report.docx` + `.pdf` | 430 | 8 | 44 |
| 2024 update | Jul–24/09 | `240718 Kirklees Creative Economy 2024 final.docx` + `.pdf` | 544 | 19 | 48 |
| 2026 report | 26/05 | `260528 Kirklees-creative-industries-economic-impact-report-2026-FINAL.docx` + `.pdf` | 608 | 21 | 73 |
...
|---|---|---|---|---|---|---|
| KIRK-2022-v01 | 22/03/22 | `150622 Kirklees 2015 Creative Economy Report BOP Consulting_corrected.docx` | — | 687 | 15 | SUPERSEDED (2015 BOP report, corrected) |
| KIRK-2022-v02 | 22/06/22 | `2206 Kirklees Creative Economy final report_HB[40].docx` | FINAL | 386 | 8 | SUPERSEDED (HB version) |
| KIRK-2022-v03 | 22/06/28 | `2204 Kirklees Creative Economy Baseline .docx` | — | 403 | 8 | SUPERSEDED (baseline, rev=158) |
| KIRK-2022-v04 | 22/06/28 | `Kirklees Creative Industries draft report.docx` | DRAFT | 615 | 3 | SUPERSEDED (draft, rev=8) |
| KIRK-2022-v05 | 22/06/28 | `2206 Kirklees Creative Economy final 1.1.docx` | FINAL 1.1 | 386 | 8 | SUPERSEDED (v1.1) |
| **KIRK-2022-FINAL** | 22/06/28 | `2206 Kirklees Creative Economy final report.docx` + `.pdf` | FINAL | 430 | 8 | **CANONICAL** (rev=286, 44-page PDF) |
| KIRK-2022-v07 | 22/07/15 | `2207 Kirklees Creative Economy revised.docx` | — | 401 | 9 | LATER MODIFICATION (rev=125) — status unclear |

**Note:** The 22/07 "revised" version (rev=125, 401 paras, 9 tables) is later than the Jun 28 "final" (rev=286, 430 paras, 8 tables). It has fewer paragraphs but more tables. This may be a post-publication correction or a different version. Flagged as UNRESOLVED.
...
| Version ID | Date | Document | Label | Paras | Tables | Authority |
|---|---|---|---|---|---|---|
| KIRK-2024-v01 | 24/07/18 | `240627 Kirklees Creative Economy 2024.docx` | — | 528 | 18 | SUPERSEDED (rev=318) — R2 manifest source |
| **KIRK-2024-FINAL** | 24/09/23 | `240718 Kirklees Creative Economy 2024 final.docx` | FINAL | 544 | 19 | **CANONICAL** (rev=26, 48-page PDF) |
| KIRK-2024-v03 | 24/09/02 | `Kirklees key numbers shared within their impact report.docx` | — | 15 | 0 | COMPANION (key numbers summary) |
...
| Version ID | Date | Document | Label | Paras | Tables | Authority |
|---|---|---|---|---|---|---|
| KIRK-2026-v01 | 25/10/17 | `kirklees-creative-economic-impact-report.pdf` | — | — | — | SUPERSEDED (early PDF, 49 pages) |
| KIRK-2026-v02 | 26/05/25 | `kirklees-creative-economic-impact-report-2026-publication-draft.md` | DRAFT | — | — | SUPERSEDED (publication draft) |
| KIRK-2026-v03 | 26/05/27 | `260527 kirklees-creative-economic-impact-report-2026.docx` | — | 605 | 21 | SUPERSEDED (rev=2) |
| KIRK-2026-v04 | 26/05/27 | `260527 kirklees-creative-economy-impact-report-2026.docx` | — | 603 | 14 | SUPERSEDED (different title spelling, fewer tables) |
| **KIRK-2026-FINAL** | 26/05/28 | `260528 Kirklees-creative-industries-economic-impact-report-2026-FINAL.docx` | FINAL | 608 | 21 | **CANONICAL** (rev=2, 73-page PDF) |
| KIRK-2026-v06 | 26/05/30 | `kirklees-creative-economic-impact-report-2026.docx` | — | 586 | 0 | LATER but 0 tables — different format? |
...
- **Method:** Updated mapping with additional data sources. Table count more than doubled (8→19). Paragraph count increased (430→544). New data: Beauhurst export (24/07), workforce dashboard, Holmfirth art week venues. High revision count (rev=318) on the Jul 18 version suggests intensive iteration.
...
4. **The R2 manifest source is the wrong version.** SRC-R2-11 is the 24/07/18 version (528 paras, 18 tables), not the Sep 23 "final" (544 paras, 19 tables). The R2 source should be updated.
5. **The 2022 "revised" version (22/07)** is UNRESOLVED — is it a correction or a different version?
...
1. Is the 22/07 "revised" version a correction to the 2022 final, or a different version?
2. Is the 26/05/30 version (0 tables) a text-only export or a different format?
3. ~~Were the 2022 and 2024 reports accepted by the client?~~ RESOLVED: Both accepted (confirmed by Iain, 26/09/09).
4. ~~Was the 2026 report accepted by the client?~~ RESOLVED: 2026 report is still in progress / not yet accepted (confirmed by Iain, 26/09/09).
...
## 9. Methodology evaluation questions (Iain, 26/09/09)
