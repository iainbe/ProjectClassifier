...
- Every new test/pilot row carries `codebook_version=1.2-candidate` and `review_batch` (e.g. R2-DIAGNOSTIC, R2-TRANSFER, R3-PILOT). Historical labels remain in review history, not silently relabelled.
