...
| Field | Value | Source |
|---|---|---|
| `project_id` | P05-WMCA | 01_projects.csv |
| `project_name` | WMCA Creative Business Scale-up Mapping | 01_projects.csv |
...
| Field | Value | Source |
|---|---|---|
| `headline_finding` | Only 26 of 645 shortlisted West Midlands creative businesses met both DCMS CAG criteria — but 297 additional businesses met one criterion and showed scale-up potential, and 98 more showed potential despite meeting neither criterion | SRC-R2-06 |
| `key_findings` | (BOP Consulting report; Iain Bennett as BOP associate) (1) 645 businesses shortlisted from 2,336 longlist; (2) 26 met both CAG criteria (50% IT/software, 23% non-DCMS, 15% music); (3) 386 met one CAG criterion; (4) 168 met 2-3 scale-up criteria; (5) 253 met 1 scale-up criterion; (6) all 26 CAG-compliant scored well on scale-up (14 Very Good, 12 Good); (7) 297 of 386 one-CAG scored well (129 Very Good, 168 Good); (8) 98 no-CAG showed potential (25 Very Good) | SRC-R2-06 Tables 4-8 |
| `quantified_results` | 645 shortlisted; 26 both CAG; 386 one CAG; 168 2-3 scale-up; 253 1 scale-up; 297 + 98 potential | 06_measurements.csv |
| `client_decision_use` | NOT_ESTABLISHED — no decision-use claim found | 04_claims.csv |
| `evidence_strength` | MEDIUM — substantial data analysis (645 businesses scored); delivered under BOP associate arrangement (fees to Fifth Sector); methodology is BOP/Curator joint work | Derived |
...
| `option_analysis` | Scale-up scoring identifies option value in businesses not meeting CAG criteria — potential future beneficiaries | SRC-R2-06 |
| `causal_analysis` | DESCRIPTIVE — classification and scoring, no counterfactual | 04_claims.csv |
| `measurement_approach` | Quantitative scoring: CAG criteria assessment, scale-up scoring (Very Good/Good), business count by sector and supply chain | SRC-R2-06 |

### B2. Repeatability and transferability

| Field | Value | Source |
|---|---|---|
| `repeatability` | MEDIUM — scale-up scoring methodology is repeatable but requires Curator Technologies data partnership and BRES access; subcontractor role limits direct precedent | Derived |
...
| Field | Value | Source |
|---|---|---|
| `tender_relevance_tags` | creative-business-scaleup, cluster-mapping, subcontractor, BOP-consulting, west-midlands, scale-up-scoring, CAG-criteria | Derived |
| `buyer_types` | Combined authority, DCMS programme partner | Derived |
| `precedent_strength` | MODERATE — delivered under BOP associate arrangement (fees to Fifth Sector); claimable as company experience delivered under BOP contract, subject to how the associate arrangement is evidenced | Derived |
| `precedent_caveats` | BOP associate arrangement — client contract was BOP's; CAG criteria were DCMS-set; scale-up methodology is joint BOP/Curator work; 2020 date; tender use should describe as "delivered by Fifth Sector under BOP associate arrangement" not sole company delivery | Derived |
| `positioning_notes` | Demonstrates capability in business classification and scale-up assessment under associate arrangements; describe honestly as BOP-contracted work paid to The Fifth Sector | Derived |
