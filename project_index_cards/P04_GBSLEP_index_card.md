...
| Field | Value | Source |
|---|---|---|
| `project_id` | P04-GBSLEP | 01_projects.csv |
| `project_name` | GBSLEP Creative Economy Mapping | 01_projects.csv |
...
| Field | Value | Source |
|---|---|---|
| `headline_finding` | The Creative Economy of Greater Birmingham generates £4.1 billion in GVA — 9% of total GBSLEP output — with approximately 50,000 Creative Economy workers (5.6% of total workforce, larger share than Advanced Manufacturing & Engineering) | SRC-R2-03 Executive Summary |
| `key_findings` | (BOP Consulting report; Fifth Sector co-lead) (1) £4.1bn GVA / 9% of GBSLEP output; (2) ~50,000 Creative Economy workers / 5.6% of workforce; (3) 6,150 Digital & Creative businesses (up from 5,100 in 2010); (4) 18,400 Creative Services workers generating £1.9bn; (5) 16,850 Creative Content workers generating £1.4bn; (6) Crafts cluster 11x national concentration in Birmingham centre (LQ 6.2 for GBSLEP area); (7) 32,000 in Advertising/Marketing + IT occupations embedding innovation across all sectors | SRC-R2-03 Executive Summary |
| `quantified_results` | £4.1bn GVA; 50,000 workers; 6,150 businesses; £1.9bn Creative Services GVA; £1.4bn Creative Content GVA; 32,000 cross-sector creative occupations | 06_measurements.csv |
| `client_decision_use` | NOT_ESTABLISHED — no decision-use claim found in reviewed claims | 04_claims.csv |
| `evidence_strength` | MEDIUM — substantial quantitative mapping (54 tables); Fifth Sector co-led (with Jonathan Todd) though BOP prime; 2017 date limits precedent value | Derived |
...
| `option_analysis` | Creative economy mapped as platform for wider economic growth — creative skills embedded in all sectors; option value implicit in "enhancing the potential growth of the whole Greater Birmingham economy" | SRC-R2-03 Executive Summary |
| `causal_analysis` | DESCRIPTIVE — mapping and estimation, no counterfactual | 04_claims.csv |
| `measurement_approach` | Quantitative mapping: BRES employment, ONS/NOMIS, LinkedIn alternative data, GVA estimates from DCMS methodology; qualitative consultation workshops | SRC-R2-03 |

### B2. Repeatability and transferability

| Field | Value | Source |
|---|---|---|
| `repeatability` | MEDIUM — mapping approach is repeatable but requires LinkedIn data access, ONS VML access, and consultation infrastructure; BOP prime limits Fifth Sector's direct precedent claim | Derived |
